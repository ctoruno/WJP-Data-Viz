...
BarSimpleChartViz <- function(data = data2plot, 
  ...
  plt <- ggplot(data, 
    ...
    annotate('rect', xmin=(shade_xminvalue-shade_xminvalue), xmax= shade_xminvalue, ymin=0, ymax=100, alpha=.1, fill="#fa4d57") +
    annotate('rect', xmin=shade_xmaxvalue, xmax= shade_xmaxvalue, ymin=0, ymax=100, alpha=.1, fill="#43a9a7") +
...
BarSimpleChartVizGrl <- function(data = data2plot, 
                              x_var = main_var, 
                              y_var = value2plot, 
                              label_var = figure, 
                              fill_var = main_var,
